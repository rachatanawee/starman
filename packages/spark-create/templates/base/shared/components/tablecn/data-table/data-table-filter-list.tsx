...
import { dataTableConfig } from "@/shared/components/tablecn/config/data-table";
...
import type {
  ...
  FilterOperator,
  JoinOperator,
} from "@/shared/components/tablecn/types/data-table";
...
export function DataTableFilterList<TData>({
  ...
  return (
    <Sortable
      value={Array.isArray(filters) ? filters : []}
        ...
        >
          <div className="flex flex-col gap-1">
            <h4 id={labelId} className="font-medium leading-none">
              {Array.isArray(filters) && filters.length > 0 ? "Filters" : "No filters applied"}
            </h4>
            <p
              id={descriptionId}
              className={cn(
                "text-muted-foreground text-sm",
                Array.isArray(filters) && filters.length > 0 && "sr-only",
              )}
            >
              {Array.isArray(filters) && filters.length > 0
